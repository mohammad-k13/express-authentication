...
const Home = () => {
  return (
    <section className="w-full h-screen flex items-center justify-center"><Tabs defaultValue="account" className="w-[400px] h-[600px] flex items-center justify-start flex-col">
